/*
 * @Author: wuchangping
 * @Date: 2021-01-16 18:39:42
 * @LastEditTime: 2021-01-17 18:34:27
 * @LastEditors: wuchangping
 * @Description: 爬取网页图片
 * @FilePath: /node-image/src/views/cmp/nodeGetImage.js
 * @记得注释
 */
...
const pageDir = `${srcPath}${sep}static${sep}pages${sep}`
...
const url =  'https://author.baidu.com/home?from=bjh_article&app_id=1640718207198641'
